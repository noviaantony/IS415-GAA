...
-   tmap: This is our go-to package for crafting thematic maps, including types like choropleths and bubble maps. For a comprehensive analysis, we'll also revisit packages from our previous lesson:
